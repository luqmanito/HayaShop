...
const AddPromo = ({navigation}) => {
  ...
  const handleInputValue3 = (text, type) => {
    setDiscount({[type]: text});
  };
  const handleInputValue4 = (text, type) => {
    setDelivery({[type]: text});
  };
  const handleInputValue5 = (text, type) => {
    setExpire({[type]: text});
  };
  const handleInputValue6 = (text, type) => {
    setDesc({[type]: text});
  };
  ...
  const msg = () => {
    showMessage({
      message: 'Added new promo success!',
      type: 'success',
    });
  };
  const msg2 = () => {
    showMessage({
      message: 'Sorry add new promo failed!',
      type: 'danger',
    });
  };
  ...
  if (body.expire !== undefined) {
    data.append('expire', body.expire);
  }
  ...
  console.log(data);
  const onPressSave = () => {
    dispatch(promoAction.addPromoThunk(data, token, msg, msg2));
  };
      ...
      <View style={styles.container}>
        <View style={styles.main}>
          ...
          <View style={styles.sect}>
            <Text style={styles.head}>New Promo</Text>
          </View>
          <View style={styles.sect}>
        ...
        <View style={styles.wrappers}>
          <TextInput
            ...
            onChangeText={text => {
              handleInputValue2(text, 'price');
              onChangeHandler(text, 'price');
            }}
            style={styles.form}
          />
        </View>
        <Text style={styles.tagcat}>Discount :</Text>
        <View style={styles.wrappers}>
          <TextInput
            multiline={true}
            numberOfLines={3}
            ...
            style={styles.form}
            onChangeText={text => {
              handleInputValue3(text, 'discount');
              onChangeHandler(text, 'discount');
            }}
          />
        </View>
        ...
        <View style={styles.wrappers}>
          <TextInput
            ...
            numberOfLines={3}
            // value={addressUser}
            placeholder="Choose delivery information for this promo"
            style={styles.form}
            onChangeText={text => {
              handleInputValue4(text, 'delivery_info');
        ...
        <Text style={styles.tagcat}>Expired Date :</Text>
        <View style={styles.wrappers}>
          <TextInput
            multiline={true}
            numberOfLines={3}
            ...
            style={styles.form}
            onChangeText={text => {
              handleInputValue5(text, 'expire');
              onChangeHandler(text, 'expire');
            }}
          />
        </View>
        ...
        <View style={styles.wrappers}>
          <TextInput
            ...
            numberOfLines={3}
            // value={addressUser}
            placeholder="Describe your product min. 500 characters include terms and condition"
            style={styles.form}
            onChangeText={text => {
              handleInputValue6(text, 'description');
              onChangeHandler(text, 'description');
            }}
          />
        </View>
        <View style={styles.buttons5}>
            <Pressable style={styles.inbuttons5} onPress={onPressSave}>
              <Text
                style={{
                  fontSize: 24,
                  fontWeight: '600',
